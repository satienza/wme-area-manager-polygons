...
Feature-complete, published userscript (v0.11.0 — see `CHANGELOG.md` for details): rectangle and free-form polygon drawing, area validation by editor level, save/load/edit/export of named shapes, i18n, and Greasyfork packaging.
