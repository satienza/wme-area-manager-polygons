...
Feature-complete, published userscript (v0.15.0 — see `CHANGELOG.md` for details): rectangle and free-form polygon drawing, area validation by editor level with a live area/limit label while editing a polygon (hidden during a whole-shape drag in favor of a drag-indicator icon and gray fill/outline), save/load/edit/export of named shapes (copied straight to the clipboard), i18n, and Greasyfork packaging.
